    ...
    <div class="json-viewer" id="${id}">
      <div class="json-header">
        ...
        <div class="json-header-right">
          <button class="btn btn-xs btn-secondary" data-action="expandPayload" data-payload-title="${escapeHtml(title)}" data-payload-raw="${escapeHtml(raw)}" type="button" title="Expand to fullscreen modal">

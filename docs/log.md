...
* **Update**: Added dashboard Settings (retention, timeouts, private mode), Autoscaling (policy form with queue eligibility plus live recommendations), and Audit Log (filters, paging) views, with acceptance coverage in the [dashboard checklist](manual/dashboard-acceptance.md).
